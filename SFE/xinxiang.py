...
if __name__=='__main__':
    ...
    # zips()
    lists ,_,list_num = get_mp4_info(url)
    for _ in lists:
        car_number = _['license']
        car_color =_['licenseTypeStr']
        ...
        with open('data.txt',mode='a') as f:
            f.write(targit)
            f.write('\n')
        # print(car_number,car_color,grab_time,grab_point,ringelman)
    print(list_num)