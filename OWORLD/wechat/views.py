...
from login_wx import index_wx_func,get_data_wx_func,login_wx_func
from login_labor import login_labor_func
...
def login_labor(request):
    s = login_labor_func(request)
    return s
