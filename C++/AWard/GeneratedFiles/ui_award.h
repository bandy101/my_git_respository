...
"selection-color:rgb(0, 255, 0); "));
        ...
        regst_code->setEnabled(false);
        regst_code->setGeometry(QRect(60, 40, 331, 61));
        QFont font;
        regst_code->setFont(font);
        regst_code->setStyleSheet(QStringLiteral("background-color:qconicalgradient(cx:0.5, cy:0.5, angle:0, stop:0 rgba(78, 80, 242, 255), stop:1 rgba(255, 255, 255, 255))"));
        ...
        award_code->setEnabled(false);
        award_code->setGeometry(QRect(60, 30, 331, 61));
        award_code->setFont(font);
        award_code->setStyleSheet(QStringLiteral("background-color:qconicalgradient(cx:0.5, cy:0.5, angle:0, stop:0 rgba(78, 80, 242, 255), stop:1 rgba(255, 255, 255, 255))"));
    ...
    void retranslateUi(QMainWindow *AWardClass)
    {
        ...
        regst_code->setText(QApplication::translate("AWardClass", "\347\232\204", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("AWardClass", "\346\216\210\346\235\203\347\240\201", Q_NULLPTR));
